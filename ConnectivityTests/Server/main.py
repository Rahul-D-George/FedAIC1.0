...
from ConnectivityTests.Utils.Net import Net, test
from ConnectivityTests.Utils.FedParams import get_parameters, set_parameters
...
while True:
    fl.server.start_server(
        server_address="172.26.80.1:8080",
